...
const DeviceItem = GObject.registerClass({
    ...
    constructor(airpodPanel, path, model, data) {
        ...
        if (this._multipleInfo) {
            ...
            const leftBatteryBox =  new St.BoxLayout({...boxLayoutProps});
            const rightBatteryBox =  new St.BoxLayout({...boxLayoutProps});
            const caseBatteryBox =  new St.BoxLayout({...boxLayoutProps});
            ...
            const singleBatteryBox =  new St.BoxLayout({...boxLayoutProps});
